...
6. If you want to use Postgres, in `.env` set `DB_TYPE=pg`. (Otherwise, you will use sqlite.) Also, if you use Postgres, set `DB_PORT=5432`, which is the default port for Postgres.
