...
export async function handleIncomingMessage(message) {
  ...
  //do we need the sms_id to be used here?
  const pendingMessagePart = new PendingMessagePart({
    service: "telnyx",
    // service_id, // where does this come from?
    parent_id: null, //why is this null?
    service_message: body,
    user_number: from, // not sure if these should be switched
    contact_number: to
  });
