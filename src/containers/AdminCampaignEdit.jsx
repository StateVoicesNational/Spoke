...
class AdminCampaignEdit extends React.Component {
  ...
  renderStartButton() {
    ...
    const orgConfigured = this.props.organizationData.organization.fullyConfigured;
    ...
    return (
      ...
      >
        ...
        >
          {!orgConfigured
            ? <span>Your organization is missing required configuration. Please <Link to={settingsLink}>update your settings</Link> or contact an adminstrator</span>
            : !isCompleted
