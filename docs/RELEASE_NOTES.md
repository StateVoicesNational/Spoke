...
* If you are running Spoke on Heroku and updating to version 11, either remove SUPPRESS_MIGRATIONS="" if it is set in config, *or* set SUPPRESS_MIGRATIONS=false
