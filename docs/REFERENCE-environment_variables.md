...
ASSIGNMENT_NOTIFICATION_EMAIL     | Can set this to a string in order to have a custom notification email for texters per Spoke instance. If not included, message is defaulted.
