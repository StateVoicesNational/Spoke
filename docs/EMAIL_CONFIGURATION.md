...
This guide explains how to configure Spoke to send email notifications. Email notifications are sent for account-related actions, to remind texters when they have messages to send and for data exports. See the .[Data Exporting doc].(DATA_EXPORTING.md) in the /docs folder re setting up an AWS S3 'bucket' to receive exports.
