...
describe('OrganizationJoinLink tests A', () => {
  ...
  test('finds proper text for invite when campaignId is present', () => {
    ...
    // then
    expect(inviteText.prop('textContent')).toBe('Send your texting volunteers this link! Once they sign up, they\'ll be automatically assigned to this campaign.')
...
describe('OrganizationJoinLink tests B', () => {
  ...
  test('finds proper text for invite when capaignId is null', () => {
    ...
    const inviteText = wrapper.find('DisplayLink')
    // then
    expect(inviteText.prop('textContent')).toBe('Send your texting volunteers this link! Once they sign up, they\'ll be automatically assigned to this organization.')
