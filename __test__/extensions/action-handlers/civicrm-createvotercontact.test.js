  ...
  describe("gvirs-createvotercontact getClientChoiceData()", () => {
    it("returns successful data when data is available", async () => {
      expect(
        ...
        data:
          '{"items":[{"name":"Support level 1 (Strong support)","details":"{\\"index\\":0,\\"support\\":1,\\"contact_status_id\\":1,\\"notes\\":\\"[From Spoke]\\"}"},{"name":"Support level 2 (Weak support)","details":"{\\"index\\":1,\\"support\\":2,\\"contact_status_id\\":1,\\"notes\\":\\"[From Spoke]\\"}"},{"name":"Support level 3 (Undecided)","details":"{\\"index\\":2,\\"support\\":3,\\"contact_status_id\\":1,\\"notes\\":\\"[From Spoke]\\"}"},{"name":"Support level 4 (Weak oppose)","details":"{\\"index\\":3,\\"support\\":4,\\"contact_status_id\\":1,\\"notes\\":\\"[From Spoke]\\"}"},{"name":"Support level 5 (Strong oppose)","details":"{\\"index\\":4,\\"support\\":5,\\"contact_status_id\\":1,\\"notes\\":\\"[From Spoke]\\"}"},{"name":"Non-Meaningful Interaction","details":"{\\"index\\":5,\\"support\\":0,\\"contact_status_id\\":0,\\"notes\\":\\"[From Spoke]\\"}"},{"name":"Busy","details":"{\\"index\\":6,\\"support\\":0,\\"contact_status_id\\":2,\\"notes\\":\\"[From Spoke]\\"}"},{"name":"Language Barrier","details":"{\\"index\\":7,\\"support\\":0,\\"contact_status_id\\":3,\\"notes\\":\\"[From Spoke]\\"}"},{"name":"No Answer","details":"{\\"index\\":8,\\"support\\":0,\\"contact_status_id\\":4,\\"notes\\":\\"[From Spoke]\\"}"},{"name":"Bad Info","details":"{\\"index\\":9,\\"support\\":0,\\"contact_status_id\\":5,\\"notes\\":\\"[From Spoke]\\"}"},{"name":"Inaccessible","details":"{\\"index\\":10,\\"support\\":0,\\"contact_status_id\\":6,\\"notes\\":\\"[From Spoke]\\"}"},{"name":"Refused","details":"{\\"index\\":11,\\"support\\":0,\\"contact_status_id\\":7,\\"notes\\":\\"[From Spoke]\\"}"}]}',
        expiresSeconds: GVIRS_CACHE_SECONDS
      });
    });
  });
